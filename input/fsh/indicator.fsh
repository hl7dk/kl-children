...
* code.coding = $FBOE#bee30064-8436-4762-83ed-e47d65f23fc6 "Samvær, kontakt, forældre-barn relation" 
* valueCodeableConcept = $FBOE#96e3eda6-3eb7-4fbb-9850-fc6dfafadb4a "Problem/bemærkning" 
* status = #final
...
* code.coding = $FBOE#2c39af9f-8e45-4c88-962f-e7a9e2cd31b6 "Forælders psykiske tilstand" 
* valueCodeableConcept = $FBOE#96e3eda6-3eb7-4fbb-9850-fc6dfafadb4a "Problem/bemærkning" 
* status = #final
* effectiveDateTime = 2020-07-07T00:00:00.000Z
